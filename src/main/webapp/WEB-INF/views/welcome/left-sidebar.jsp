			...
			<ul id="sidebarnav">
				<li class="user-profile"><a
					...
					aria-expanded="false"><img
						...
						alt="user" /><span class="hide-menu">Jinil Soni </span></a>
				...
				<li class="nav-small-cap">FOOD BUFF</li>
				...
				<li><a class="has-arrow waves-effect waves-dark" href="#"
					...
					<ul aria-expanded="false" class="collapse">
						...
						<li><a href="../product-liberary">Products Library</a></li>
					</ul></li> -->
				<li class="nav-small-cap">FOOD BUFF</li>
				<li><a class="has-arrow waves-effect waves-dark" href="#"
					aria-expanded="false"><i class="mdi mdi-gauge"></i><span
						class="hide-menu">Restaurant <span
							class="label label-rouded label-themecolor pull-right">4</span></span></a>
					<ul aria-expanded="false" class="collapse">
						<li><a href="../add-restaurant">Add Restaurant</a></li>
						<li><a href="../restaurant-list">Restaurant List</a></li>
					</ul></li>
				<!-- <li><a class="has-arrow waves-effect waves-dark" href="#"
					aria-expanded="false"><i class="ti ti-agenda"></i><span
						class="hide-menu">Forms<span
							class="label label-rouded label-themecolor pull-right">4</span></span></a>
					<ul aria-expanded="false" class="collapse">
						<li><a href="../add-form">Add Form </a></li>
						<li><a href="../edit-form">Edit Form</a></li>
						<li><a href="../form-list">Forms List</a></li>
					</ul></li>
				<li><a class="has-arrow waves-effect waves-dark" href="#"
					aria-expanded="false"><i class="mdi-account-box"></i><span
						class="hide-menu">Customer<span
							class="label label-rouded label-themecolor pull-right">4</span></span></a>
					<ul aria-expanded="false" class="collapse">
						<li><a href="../add-customer">Add Customer </a></li>
						<li><a href="../edit-customer/{customerId}">Edit Customer</a></li>
						<li><a href="../customer-list">Customers List</a></li>
					</ul></li>
				<li><a class="has-arrow waves-effect waves-dark" href="#"
					aria-expanded="false"><i class="mdi mdi-phone"></i><span
						class="hide-menu">ContactList <span
							class="label label-rouded label-themecolor pull-right">4</span></span></a>
					<ul aria-expanded="false" class="collapse">
						<li><a href="../contactlist">ContactList </a></li>
					</ul></li> -->
